def print_nba_game_stats(data_dict):
    ...
    for i in range (len(data_dict["players_data"])):
        print(data_dict["players_data"][i]["player_name"] + "   "+str(data_dict["players_data"][i]["FG"])+ "    "+str(data_dict["players_data"][i]["FGA"])+"    "+str(data_dict["players_data"][i]["FG%"])+"    "+str(data_dict["players_data"][i]["3P"])+"   "+str(data_dict["players_data"][i]["3PA"])+"    "+str(data_dict["players_data"][i]["3P%"])+"    "+str(data_dict["players_data"][i]["FT"])+"   "+str(data_dict["players_data"][i]["FTA"])+"    "+str(data_dict["players_data"][i]["FT%"])+"    "+str(data_dict["players_data"][i]["ORB"])+"    "+str(data_dict["players_data"][i]["DRB"])+"    "+str(data_dict["players_data"][i]["TRB"])+"    "+str(data_dict["players_data"][i]["AST"])+"    "+str(data_dict["players_data"][i]["STL"])+"    "+str(data_dict["players_data"][i]["BLK"])+"    "+str(data_dict["players_data"][i]["TOV"])+"    "+str(data_dict["players_data"][i]["PF"])+"   "+str(data_dict["players_data"][i]["PTS"]))
    ...
    for c in range(len(players)):
        ...
        if match != None:
            ...
            if players[c][2]==players[0][3]:
                if foul==None:
                    a_players_data.append({"player_name":match.group(),"FG": fg, "FGA": fga, "FG%": d, "3P": p, "3PA": pa, "3P%":d, "FT": ft, "FTA": fta, "FT%": d, "ORB": orb, "DRB": drb, "TRB": trb, "AST": ast, "STL": stl, "BLK": blk, "TOV": tov, "PF": pf, "PTS": pts})
